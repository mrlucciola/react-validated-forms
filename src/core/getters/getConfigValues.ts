...
const getCalculatedValues = <D extends ConfigInternal<any, any, any>>(
  ...
  parsedExternalValues: D["externalSchema"] extends void
    ? undefined
    : NonNullable<ExtValues<D["externalSchema"]>>
...
const getConfigValues = <D extends ConfigInternal<any, any, any>>(
  ...
  const out = {
    form: uiValues,
    external: parsedExternalValues as ExtValues<NonNullable<C["externalSchema"]>>,
    calculated: calculatedValues as D extends ConfigInternal<any, any, infer T> ? T : undefined,
  };
